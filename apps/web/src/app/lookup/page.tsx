...
export default function LookupPage() {
  return (
    <div className="mx-auto w-full max-w-[1280px] px-6 py-10">
      <p className="text-xs font-semibold tracking-[0.04em] text-[#006972] uppercase">Tra cứu</p>
      ...
      <Section title="Cách đọc kết quả" sub="Thứ hạng càng nhỏ càng tốt. Top 5% nghĩa là điểm của bạn cao hơn 95% thí sinh cùng tổ hợp.">
        <ul className="max-w-2xl list-disc space-y-2 pl-5 text-sm leading-relaxed text-[#43474e]">
