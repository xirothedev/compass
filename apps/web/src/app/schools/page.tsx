...
export default async function SchoolsPage({
  ...
  return (
    <div className="mx-auto w-full max-w-[1280px] px-6 py-10">
      <p className="text-xs font-semibold tracking-[0.04em] text-accent uppercase">Catalog</p>
      ...
      <Section title="Cam kết dữ liệu" sub="Dữ liệu vì tương lai thí sinh. Compass chỉ dùng dữ liệu công khai từ đề án tuyển sinh các trường.">
        <p className="text-sm text-muted">Điểm chuẩn mang tính tham khảo. Thí sinh đối chiếu quy chế tuyển sinh chính thức của Bộ GD&ĐT.</p>
      </Section>
    </div>
  );
}
