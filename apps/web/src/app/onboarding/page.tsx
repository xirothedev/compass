...
export const metadata = { title: "Định hướng Nguyện vọng - Compass" };

export default function OnboardingPage() {
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-8 md:px-8 lg:px-12">
      <nav aria-label="Điều hướng" className="text-center text-[13px] text-muted">
        <Link href="/" className="hover:text-ink">Trang chủ</Link>
        <span aria-hidden> / </span>
        <span aria-current="page" className="text-ink">Định hướng Nguyện vọng</span>
      </nav>
      ...
      <h1 className="mx-auto mt-3 max-w-2xl text-center text-[32px] font-bold leading-[40px] tracking-tight text-ink md:text-[40px] md:leading-[48px]">
        Định hướng Nguyện vọng thông minh
      </h1>
      <p className="mx-auto mt-3 max-w-xl text-center text-base leading-relaxed text-body">
        Hoàn thiện 4 bước Định hướng ngắn trong 2 phút để Compass gợi ý giỏ Nguyện vọng đầu tiên.
      </p>
      <div className="mt-8">
        <OnboardingWizard />
      </div>
